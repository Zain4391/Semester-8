...
2. [Why is Testing Necessary?](#2-why-is-testing-necessary)
3. [Quality vs Testing](#3-quality-vs-testing)
4. [Testing General Vocabulary](#4-general-testing-terms-and-vocabulary)
5. [Testing Objectives](#5-testing-objectives)
6. [General Testing Principles](#6-general-testing-principles)
7. [Test Process](#7-test-process)
...
| **Test Suite** | Set of test cases or test procedures to be executed in a specific test cycle<br>**Test Suite = Test Procedure + Test Case** |
